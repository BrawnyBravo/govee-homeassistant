...
| A **"Govee API rate limited"** repair appears | Polling is spending the API budget faster than Govee allows. Open the repair and select **Submit** to double the polling interval (up to 300 s), or raise it yourself under **Configure**. |
